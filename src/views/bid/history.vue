  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="LeftTime" width="100px" align="center">
        <template slot-scope="{row}">
          <Timer :exitTime="row.exitTime"  :key="row.id"/>
        </template>
      </el-table-column>

      <el-table-column :label="$t('table.user')+'ID'" width="90" align="center">
        <template slot-scope="{row}">
          <span>{{ row.userId }}</span>
        </template>
      </el-table-column> 
      <el-table-column :label="$t('bid.price')" width="90" align="center">
        <template slot-scope="{row}">
          <span>{{ row.price }}</span>
        </template>
      </el-table-column> 
